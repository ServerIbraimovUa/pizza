...
import { PayOrderTemplate } from "@/shared/components/shared/email-templetes/pay-order";
import { RegisterVerification } from "@/shared/components/shared/email-templetes/register-verification";
    ...
    try {
        ...
        await sendEmail(
            ...
            PayOrderTemplate({
                ...
                paymentUrl: "https://dadata.ru/api/",
            })
        );
    } catch (error) {
